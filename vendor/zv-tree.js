...
/***/ function(module, exports, __webpack_require__) {
	...
	var _render = __webpack_require__(299);
	...
	function draw() {
	    ...
	    var render = new _render.RenderTree({ n: config.size,
	        trunk: config.trunk,
	    ...
	    var tree = new _tree.Tree({ root_x: config.mid,
	        root_y: 0.90,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RenderTree = exports.RenderTree = function () {
	    function RenderTree(kwargs) {
	    ...
	    _createClass(RenderTree, [{
	        ...
	        key: 'fillRectN',
	        value: function fillRectN(x, y, n) {
	            var scale = this.n;
	            var adj_x = x * scale,
	                adj_y = y * scale;
	        ...
	        key: 'fillLine',
	        value: function fillLine(start, end) {
	        ...
	        value: function drawBranch(b) {
	            ...
	            var x1 = x + Math.cos(a - 0.5 * _utils.PI) * r,
	                x2 = x + Math.cos(a + 0.5 * _utils.PI) * r,
	                y1 = y + Math.sin(a - 0.5 * _utils.PI) * r,
	                y2 = y + Math.sin(a + 0.5 * _utils.PI) * r;
	            ...
	            var makeTrunk = function makeTrunk(xl, yl, the, dd, len) {
	                var scales = [];
	
	                for (var i = 0; i <= len; i++) {
	                    scales[i] = Math.random() * dd * Math.random();
	                }
	                var xxp = scales.map(function (s) {
	                    return xl - s * Math.cos(the);
	                }),
	                    yyp = scales.map(function (s) {
	                    return yl - s * Math.sin(the);
	                });
	                (0, _utils.zip)(xxp, yyp).map(function (_ref) {
	                    var _ref2 = _slicedToArray(_ref, 2);
	
	                    var xx = _ref2[0];
	                    var yy = _ref2[1];
	                    return _this.fillPixel(xx, yy);
	                });
	            };
	
	            // Trunk shade right
	            makeTrunk(x2, y2, 0.5 * _utils.PI + a, // val
	            Math.sqrt((0, _utils.square)(x - x2) + (0, _utils.square)(y - y2)), // dd
	            this.grains); // len
	
	            // Trunk shade left
	            makeTrunk(x1, y1, a - 0.5 * _utils.PI, // val
	            Math.sqrt((0, _utils.square)(x - x1) + (0, _utils.square)(y - y1)), // dd
	            this.grains / 5); // len
	        }
	    }]);
	...
	var Branch = function () {
	    ...
	    _createClass(Branch, [{
	        ...
	        value: function step() {
	            ...
	            var angle = (0, _utils.normalDistribution)() * this.tree.branch_angle_max;
	...
	var Tree = exports.Tree = function () {
	    ...
	    _createClass(Tree, [{
	        ...
	        value: function step() {
	            ...
	            try {
	                for (var _iterator = this.Q.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var _step$value = _slicedToArray(_step.value, 2);
	
	                    var i = _step$value[0];
	                    var branch = _step$value[1];
	                    ...
	                    var branch_prob = (this.root_r - branch.r + this.one) * this.branch_prob_scale;
	                    if ((0, _utils.uniformRandom)() < branch_prob) {
	                        var x = branch.x;
	                        var y = branch.y;
	                        var a = branch.a;
	                        var r = branch.r;
	                        ...
	                        var new_r = this.branch_split_diminish * r;
	                        var ra = Math.pow(-1, (0, _utils.randomInteger)(2)) * (0, _utils.uniformRandom)() * this.branch_split_angle;
	            ...
	            try {
	                for (var _iterator2 = q_remove[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    var _r = _step2.value;
